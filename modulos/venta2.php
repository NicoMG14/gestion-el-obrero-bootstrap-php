...
$totaldia=0;
if (isset($_POST['Tfecha'])){
      $fecha_select=$_POST['fecha'];
    }
$tabla_filas="";
...
if($conexion=="si"){
    $query = "SELECT venta_cod,venta_fecha,venta_total,cliente.cliente_nom,usuario.usuario_nom FROM venta
        ...
        WHERE venta_fecha='$fecha_select'
...
<h4 align="center">Ventas realizadas el dia: <?php echo $fecha_select; ?></h4>
...
<?php 
  $query= " SELECT venta.usuario_cod,usuario.usuario_nom,venta_fecha, COUNT(venta.usuario_cod) tot
            FROM venta,usuario
            WHERE venta.usuario_cod=usuario.usuario_cod AND venta_fecha='$fecha_select'
...
<h5>Usuario destacado: <?php echo $usuariodest; ?></h5>
