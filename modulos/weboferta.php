            ...
            for($i=0;$i<$indexmodelo;$i++){
                ...
                <div class=\"col\">
                    <div class=\"card text-white bg-white mb-2\" style=\"width: 20rem\">
                       ...
                       <div class=\"bg-white text-end text-black d-flex justify-content-end align-items-center m-0\">
                         <span style=\"margin-top:-1rem;\" class=\"rounded-pill bg-success p-2 fs-5 me-0\">$".$producto_precio."</span>
                       </div>
                     <div class=\"card-body bg-white\">
                         <h5 class=\"card-title text-black\">".$producto_desc."</h5>
